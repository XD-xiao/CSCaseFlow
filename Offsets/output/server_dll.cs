...
namespace CS2Dumper.Schemas {
    ...
    public static class ServerDll {
        ...
        public static class CCSBot {
            ...
            public const nint m_stateTimestamp = 0x598; // float32
            public const nint m_isAttacking = 0x59C; // bool
            public const nint m_isOpeningDoor = 0x59D; // bool
            public const nint m_taskEntity = 0x5A4; // CHandle<CBaseEntity>
            public const nint m_goalPosition = 0x5B4; // VectorWS
            public const nint m_goalEntity = 0x5C0; // CHandle<CBaseEntity>
            public const nint m_avoid = 0x5C4; // CHandle<CBaseEntity>
            public const nint m_avoidTimestamp = 0x5C8; // float32
            public const nint m_isStopping = 0x5CC; // bool
            public const nint m_hasVisitedEnemySpawn = 0x5CD; // bool
            public const nint m_stillTimer = 0x5D0; // IntervalTimer
            public const nint m_bEyeAnglesUnderPathFinderControl = 0x5E0; // bool
            public const nint m_pathIndex = 0x5EE0; // int32
            public const nint m_areaEnteredTimestamp = 0x5EE4; // GameTime_t
            public const nint m_repathTimer = 0x5EE8; // CountdownTimer
            public const nint m_avoidFriendTimer = 0x5F00; // CountdownTimer
            public const nint m_isFriendInTheWay = 0x5F18; // bool
            public const nint m_politeTimer = 0x5F20; // CountdownTimer
            public const nint m_isWaitingBehindFriend = 0x5F38; // bool
            public const nint m_pathLadderEnd = 0x5F64; // float32
            public const nint m_mustRunTimer = 0x5FB0; // CountdownTimer
            public const nint m_waitTimer = 0x5FC8; // CountdownTimer
            public const nint m_updateTravelDistanceTimer = 0x5FE0; // CountdownTimer
            public const nint m_playerTravelDistance = 0x5FF8; // float32[64]
            public const nint m_travelDistancePhase = 0x60F8; // uint8
            public const nint m_hostageEscortCount = 0x6290; // uint8
            public const nint m_hostageEscortCountTimestamp = 0x6294; // float32
            public const nint m_desiredTeam = 0x6298; // int32
            public const nint m_hasJoined = 0x629C; // bool
            public const nint m_isWaitingForHostage = 0x629D; // bool
            public const nint m_inhibitWaitingForHostageTimer = 0x62A0; // CountdownTimer
            public const nint m_waitForHostageTimer = 0x62B8; // CountdownTimer
            public const nint m_noisePosition = 0x62D0; // Vector
            public const nint m_noiseTravelDistance = 0x62DC; // float32
            public const nint m_noiseTimestamp = 0x62E0; // float32
            public const nint m_noiseSource = 0x62E8; // CCSPlayerPawn*
            public const nint m_noiseBendTimer = 0x6300; // CountdownTimer
            public const nint m_bentNoisePosition = 0x6318; // Vector
            public const nint m_bendNoisePositionValid = 0x6324; // bool
            public const nint m_lookAroundStateTimestamp = 0x6328; // float32
            public const nint m_lookAheadAngle = 0x632C; // float32
            public const nint m_forwardAngle = 0x6330; // float32
            public const nint m_inhibitLookAroundTimestamp = 0x6334; // float32
            public const nint m_lookAtSpot = 0x633C; // Vector
            public const nint m_lookAtSpotDuration = 0x634C; // float32
            public const nint m_lookAtSpotTimestamp = 0x6350; // float32
            public const nint m_lookAtSpotAngleTolerance = 0x6354; // float32
            public const nint m_lookAtSpotClearIfClose = 0x6358; // bool
            public const nint m_lookAtSpotAttack = 0x6359; // bool
            public const nint m_lookAtDesc = 0x6360; // char*
            public const nint m_peripheralTimestamp = 0x6368; // float32
            public const nint m_approachPointCount = 0x64F0; // uint8
            public const nint m_approachPointViewPosition = 0x64F4; // Vector
            public const nint m_viewSteadyTimer = 0x6500; // IntervalTimer
            public const nint m_tossGrenadeTimer = 0x6518; // CountdownTimer
            public const nint m_isAvoidingGrenade = 0x6538; // CountdownTimer
            public const nint m_spotCheckTimestamp = 0x6558; // float32
            public const nint m_checkedHidingSpotCount = 0x6960; // int32
            public const nint m_lookPitch = 0x6964; // float32
            public const nint m_lookPitchVel = 0x6968; // float32
            public const nint m_lookYaw = 0x696C; // float32
            public const nint m_lookYawVel = 0x6970; // float32
            public const nint m_targetSpot = 0x6974; // Vector
            public const nint m_targetSpotVelocity = 0x6980; // Vector
            public const nint m_targetSpotPredicted = 0x698C; // Vector
            public const nint m_aimError = 0x6998; // QAngle
            public const nint m_aimGoal = 0x69A4; // QAngle
            public const nint m_targetSpotTime = 0x69B0; // GameTime_t
            public const nint m_aimFocus = 0x69B4; // float32
            public const nint m_aimFocusInterval = 0x69B8; // float32
            public const nint m_aimFocusNextUpdate = 0x69BC; // GameTime_t
            public const nint m_ignoreEnemiesTimer = 0x69C8; // CountdownTimer
            public const nint m_enemy = 0x69E0; // CHandle<CCSPlayerPawn>
            public const nint m_isEnemyVisible = 0x69E4; // bool
            public const nint m_visibleEnemyParts = 0x69E5; // uint8
            public const nint m_lastEnemyPosition = 0x69E8; // Vector
            public const nint m_lastSawEnemyTimestamp = 0x69F4; // float32
            public const nint m_firstSawEnemyTimestamp = 0x69F8; // float32
            public const nint m_currentEnemyAcquireTimestamp = 0x69FC; // float32
            public const nint m_enemyDeathTimestamp = 0x6A00; // float32
            public const nint m_friendDeathTimestamp = 0x6A04; // float32
            public const nint m_isLastEnemyDead = 0x6A08; // bool
            public const nint m_nearbyEnemyCount = 0x6A0C; // int32
            public const nint m_bomber = 0x6C18; // CHandle<CCSPlayerPawn>
            public const nint m_nearbyFriendCount = 0x6C1C; // int32
            public const nint m_closestVisibleFriend = 0x6C20; // CHandle<CCSPlayerPawn>
            public const nint m_closestVisibleHumanFriend = 0x6C24; // CHandle<CCSPlayerPawn>
            public const nint m_attentionInterval = 0x6C28; // IntervalTimer
            public const nint m_attacker = 0x6C38; // CHandle<CCSPlayerPawn>
            public const nint m_attackedTimestamp = 0x6C3C; // float32
            public const nint m_burnedByFlamesTimer = 0x6C40; // IntervalTimer
            public const nint m_lastVictimID = 0x6C50; // int32
            public const nint m_isAimingAtEnemy = 0x6C54; // bool
            public const nint m_isRapidFiring = 0x6C55; // bool
            public const nint m_equipTimer = 0x6C58; // IntervalTimer
            public const nint m_zoomTimer = 0x6C68; // CountdownTimer
            public const nint m_fireWeaponTimestamp = 0x6C80; // GameTime_t
            public const nint m_lookForWeaponsOnGroundTimer = 0x6C88; // CountdownTimer
            public const nint m_bIsSleeping = 0x6CA0; // bool
            public const nint m_isEnemySniperVisible = 0x6CA1; // bool
            public const nint m_sawEnemySniperTimer = 0x6CA8; // CountdownTimer
            public const nint m_enemyQueueIndex = 0x6D60; // uint8
            public const nint m_enemyQueueCount = 0x6D61; // uint8
            public const nint m_enemyQueueAttendIndex = 0x6D62; // uint8
            public const nint m_isStuck = 0x6D63; // bool
            public const nint m_stuckTimestamp = 0x6D64; // GameTime_t
            public const nint m_stuckSpot = 0x6D68; // Vector
            public const nint m_wiggleTimer = 0x6D78; // CountdownTimer
            public const nint m_stuckJumpTimer = 0x6D90; // CountdownTimer
            public const nint m_nextCleanupCheckTimestamp = 0x6DA8; // GameTime_t
            public const nint m_avgVel = 0x6DAC; // float32[10]
            public const nint m_avgVelIndex = 0x6DD4; // int32
            public const nint m_avgVelCount = 0x6DD8; // int32
            public const nint m_lastOrigin = 0x6DDC; // Vector
            public const nint m_lastRadioRecievedTimestamp = 0x6DEC; // float32
            public const nint m_lastRadioSentTimestamp = 0x6DF0; // float32
            public const nint m_radioSubject = 0x6DF4; // CHandle<CCSPlayerPawn>
            public const nint m_radioPosition = 0x6DF8; // Vector
            public const nint m_voiceEndTimestamp = 0x6E04; // float32
            public const nint m_lastValidReactionQueueFrame = 0x6E10; // int32
        }
        // Parent: CBaseEntity
        // Field count: 2
        //
        ...
        public static class CDecalInstance {
            ...
            public const nint m_transform = 0x60; // CTransformWS
            public const nint m_flAnimationScale = 0x80; // float32
            public const nint m_flAnimationStartTime = 0x84; // float32
            public const nint m_flPlaceTime = 0x88; // GameTime_t
            public const nint m_flFadeStartTime = 0x8C; // float32
            public const nint m_flFadeDuration = 0x90; // float32
            public const nint m_flLightingOriginOffset = 0x94; // float32
            public const nint m_flBoundingRadiusSqr = 0xA0; // float32
            public const nint m_nSequenceIndex = 0xA4; // int16
            public const nint m_bIsAdjacent = 0xA6; // bool
            public const nint m_bDoDecalLightmapping = 0xA7; // bool
            public const nint m_nDecalRtEncoding = 0xA8; // DecalRtEncoding_t
            public const nint m_bProjectToBackfaces = 0xA9; // bool
        }
        // Parent: None
        // Field count: 18
        //
        ...
        // Parent: None
        // Field count: 2
        public static class CPathMoverEntitySpawn {
        ...
        public static class CTakeDamageResult {
            ...
            public const nint m_flTotalledPreModifiedDamage = 0x20; // float32
            public const nint m_bWasDamageSuppressed = 0x24; // bool
            public const nint m_bSuppressFlinch = 0x25; // bool
            public const nint m_nOverrideFlinchHitGroup = 0x28; // HitGroup_t
        }
        // Parent: None
        // Field count: 1
        ...
        public static class CCS2ChickenGraphController {
            public const nint m_action = 0x90; // CAnimGraph2ParamOptionalRef<CGlobalSymbol>
            public const nint m_actionSubtype = 0xA8; // CAnimGraph2ParamOptionalRef<CGlobalSymbol>
            public const nint m_bActionReset = 0xC0; // CAnimGraph2ParamAutoResetOptionalRef
            public const nint m_idleVariation = 0xE0; // CAnimGraph2ParamOptionalRef<float32>
            public const nint m_runVariation = 0xF8; // CAnimGraph2ParamOptionalRef<float32>
            public const nint m_panicVariation = 0x110; // CAnimGraph2ParamOptionalRef<float32>
            public const nint m_squatVariation = 0x128; // CAnimGraph2ParamOptionalRef<float32>
            public const nint m_bInWater = 0x140; // CAnimGraph2ParamOptionalRef<bool>
            public const nint m_bHasActionCompletedEvent = 0x158; // bool
            public const nint m_bWaitingForCompletedEvent = 0x159; // bool
        }
        // Parent: None
        // Field count: 3
        ...
        public static class SummaryTakeDamageInfo_t {
            ...
            public const nint result = 0x128; // CTakeDamageResult
            public const nint hTarget = 0x158; // CHandle<CBaseEntity>
        }
        // Parent: None
        // Field count: 3
        public static class CSceneRequest {
            public const nint m_szPayloadTypeName = 0x0; // CUtlSymbolLarge
            public const nint m_uHandle = 0x8; // SceneRequestHandle_t
            public const nint m_state = 0xC; // ESceneRequestState_t
        }
        // Parent: None
        // Field count: 6
        public static class DestructiblePartDestructionRequest_t {
            public const nint m_nDestroyFlags = 0x0; // EDestructibleParts_DestroyParameterFlags
            public const nint m_nDamageType = 0x4; // DamageTypes_t
            public const nint m_flPartDamage = 0x8; // float32
            public const nint m_flPartDamageRadius = 0xC; // float32
            public const nint m_vWsPartDamageOrigin = 0x10; // VectorWS
            public const nint m_vWsPartDamageForce = 0x1C; // Vector
        }
        // Parent: None
        // Field count: 2
        ...
        public static class CNmAimCSNode__CDefinition {
            ...
            public const nint m_nIsWeaponActionActiveNodeIdx = 0x20; // int16
            public const nint m_nWeaponDropNodeIdx = 0x22; // int16
            public const nint m_nEnabledNodeIdx = 0x24; // int16
            public const nint m_flBlendTimeSeconds = 0x28; // float32
            public const nint m_flReduceRangeTimeSeconds = 0x2C; // float32
        }
        // Parent: None
        // Field count: 4
        ...
        public static class CTakeDamageInfo {
            ...
            public const nint m_nDestructibleHitGroupsToForceDestroy = 0x100; // CUtlVector<DestructibleHitGroupToDestroy_t>
            public const nint m_bInTakeDamageFlow = 0x118; // bool
        }
        // Parent: CSimpleSimTimer
        // Field count: 2
        ...
        public static class CAnimGraphControllerBase {
            public const nint m_hExternalGraph = 0x18; // ExternalAnimGraphHandle_t
        }
        // Parent: None
        // Field count: 3
