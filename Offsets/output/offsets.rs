...
pub mod cs2_dumper {
    pub mod offsets {
        // Module: client.dll
        pub mod client_dll {
            pub const dwCSGOInput: usize = 0x2319FC0;
            pub const dwEntityList: usize = 0x24AF268;
            pub const dwGameEntitySystem: usize = 0x24AF268;
            pub const dwGameEntitySystem_highestEntityIndex: usize = 0x20A0;
            pub const dwGameRules: usize = 0x230DEE0;
            pub const dwGlobalVars: usize = 0x205E5C0;
            pub const dwGlowManager: usize = 0x230ACE8;
            pub const dwLocalPlayerController: usize = 0x22F4188;
            pub const dwLocalPlayerPawn: usize = 0x2069B50;
            pub const dwPlantedC4: usize = 0x2317740;
            pub const dwPrediction: usize = 0x2069A60;
            pub const dwSensitivity: usize = 0x230B7F8;
            pub const dwSensitivity_sensitivity: usize = 0x58;
            pub const dwViewAngles: usize = 0x231A648;
            pub const dwViewMatrix: usize = 0x230FF20;
            pub const dwViewRender: usize = 0x2310338;
            pub const dwWeaponC4: usize = 0x2298F00;
        }
        // Module: engine2.dll
        pub mod engine2_dll {
            pub const dwBuildNumber: usize = 0x60D514;
            pub const dwNetworkGameClient: usize = 0x908530;
            ...
            pub const dwWindowHeight: usize = 0x90C8F4;
            pub const dwWindowWidth: usize = 0x90C8F0;
        }
